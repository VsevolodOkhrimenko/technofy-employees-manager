"""
Django settings for Employees Manager project.
...
ADMINS = [
    ('Vsevolod Okhrimenko', 'vsevolod.okhrimenko@gmail.com'),
]
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': env.str('ES_URL', 'http://elasticsearch:9200/'),
        'INDEX_NAME': 'haystack',
    },
}
...
TEMPLATES = [
    {
        ...
        'DIRS': STATICFILES_TEMPLATES_DIRS,
        'OPTIONS': {
            'debug': DEBUG,
            'loaders': [
